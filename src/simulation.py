...
from arena_envt import environment_creation
...
class Simulation: 
    ...
    def run_creature(self, cr, iterations=3000):
        ...
        peak_pos = environment_creation(arena_size=20)

        cr.set_peak_pos(peak_pos)
        ...
        p.resetBasePositionAndOrientation(cid, [-3, -8, 2.4], [0, 0, 0, 1], physicsClientId=pid)
...
class ThreadedSim():
    ...
    @staticmethod
    def static_run_creature2(sim_id, cr, iterations):
    ...
    def eval_population(self, pop, iterations):
        ...
        for pool_argset in pool_args:
            with Pool(pool_size) as p:
                ...
                creatures = p.starmap(ThreadedSim.static_run_creature2, pool_argset)
